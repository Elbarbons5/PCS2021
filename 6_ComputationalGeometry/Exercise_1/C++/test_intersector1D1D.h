...
TEST(TestIntersector1D1D, TestParallelIntersection)
{
  ...
  EXPECT_EQ(intersectorNew.TypeIntersection(), Intersector1D1D::IntersectionParallelOnSegment);
...
TEST(TestIntersector1D1D, TestSegmentIntersection)
{
  ...
  EXPECT_EQ(intersector.TypeIntersection(), Intersector1D1D::IntersectionOnSegment);
...
TEST(TestIntersector1D1D, TestOnLineIntersection)
{
  ...
  intersector.SetSecondSegment(c, d);
  EXPECT_TRUE(intersector.ComputeIntersection());
  EXPECT_EQ(intersector.TypeIntersection(), Intersector1D1D::IntersectionOnLine);
