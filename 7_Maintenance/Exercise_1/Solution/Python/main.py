...
class BookStore(IBookStore):
    ...
    def AddAuthor(self,
        ...
        self.__authors[author_id] = Author(author_id,
                                   firstName,
                                   lastName)
        self.__authorByName[firstName + "-" + lastName] = author_id # Fix
    ...
    def AddBook(self,
        ...
        self.__books[book_id] = Book(book_id,
                                     title,
                                     genre)
        self.__bookByTitle[title] = book_id # Fix
    ...
    def AddBookAuthor(self,
                      author: Author,
                      book: Book) -> bool:
        self.__bookAuthor[author.Id] = book.Id # Fix
        return True
    ...
    def FindAuthor(self,
        ...
        if author_key not in self.__authorByName:
            raise Exception("Author not found") # Fix
